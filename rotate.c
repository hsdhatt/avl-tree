...
static void rotate_left_2(struct tree_node **cur_ptr, struct tree_node **parent_ptr)
{
...
static void rotate_left_1(struct tree_node **cur_ptr, struct tree_node **parent)
{
	struct tree_node *cur, *right, *right_left;
	cur = *cur_ptr;
	right = cur->right;
...
static void rotate_right_2(struct tree_node **cur_ptr, struct tree_node **parent_ptr)
{
...
static void rotate_right_1(struct tree_node **cur_ptr, struct tree_node **parent)
{
